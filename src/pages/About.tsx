        ...
        <div className="space-y-8">
          ...
          <section className="bg-dark-800 rounded-xl p-6 border border-dark-700">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              algorithms to control a snake in a 3D grid, benchmark your code against others, and
              compete on the leaderboard. The entire platform was built as a demonstration of modern
          ...
          <section className="bg-dark-800 rounded-xl p-6 border border-dark-700">
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <span className="text-white font-medium">Grid:</span> 4,096 cells with wrapping
                  boundaries
                </li>
                <li>
                  <span className="text-white font-medium">Goal:</span> Eat food to grow and score
                  points
                </li>
                <li>
                  <span className="text-white font-medium">Avoid:</span> Colliding with your own
                  body
                </li>
                <li>
                  <span className="text-white font-medium">Limit:</span> 25,000 frames per game
                  (timeout)
                </li>
                <li>
                  <span className="text-white font-medium">Benchmark:</span> 10 games, best average
                  score wins
                </li>
              </ul>
            </div>
          ...
          <section className="bg-dark-800 rounded-xl p-6 border border-dark-700">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-300 ml-4">
              <li>
                Click <span className="text-neon-green font-medium">"+ New Algorithm"</span> to open
                the editor
              </li>
              <li>Write your snake AI using the provided template and utilities</li>
              <li>
                Use <span className="text-white font-medium">"Test Run"</span> to see your algorithm
                in action
              </li>
              <li>
                Run <span className="text-neon-blue font-medium">"Benchmark"</span> to test across
                10 games
              </li>
          ...
          <section className="bg-dark-800 rounded-xl p-6 border border-dark-700">
            ...
            <div className="font-mono text-sm space-y-2 text-gray-300">
              <div>
                <span className="text-neon-green">utils.wrapPosition(pos)</span> - Handle grid
                wrapping
              </div>
              <div>
                <span className="text-neon-green">utils.distance(a, b)</span> - Manhattan distance
                between positions
              </div>
              <div>
                <span className="text-neon-green">utils.posEqual(a, b)</span> - Check if positions
                are equal
              </div>
              <div>
                <span className="text-neon-green">utils.findPathBFS(from, to, obstacles)</span> -
                Pathfinding
              </div>
              <div>
                <span className="text-neon-green">utils.createCollisionSet(positions)</span> - Fast
                collision detection
              </div>
              <div>
                <span className="text-neon-green">utils.ALL_DIRECTIONS</span> - Array of 6 movement
                directions
              </div>
            </div>
          </section>
